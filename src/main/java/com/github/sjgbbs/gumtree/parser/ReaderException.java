 ...
 *
 * I believe most (all?) exceptions would be IOExceptions so this is of little real value given you
 * had IOException on main() but I wanted to demonstrate I new the pattern.
 *
 * @author Simon
 */
